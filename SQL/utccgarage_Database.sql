...
(12, 21, '2019-05-16 03:57:27', 'Mercedes-Ben', 'สีดำเมทัลลิก', 'E300', ' แอร์ไม่เย็น', 'สุพจ', '2019-05-14 17:00:00', '2019-05-15 10:00', 'กำลังซ่อม', 'กค1563'),
(13, 22, '2019-05-16 02:58:34', 'Toyota', 'น้ำเงิน', 'vios', 'หม้อน้ำรั่ว', 'นายดำ', '2019-05-16 17:00:00', '2019-05-23 15:30', 'เสร็จสิ้น', 'กท1010');
...
--
ALTER TABLE `queue`
  MODIFY `Queue_id_order` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
COMMIT;
